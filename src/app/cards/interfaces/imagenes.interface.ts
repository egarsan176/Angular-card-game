// To parse this data:
//
//   import { Convert, Imagenes } from "./file";
//
//   const imagenes = Convert.toImagenes(json);
//
...
export enum AltDescription {
    BabyInDiaperLyingOnBed = "baby in diaper lying on bed",
...
export class Convert {
    public static toImagenes(json: string): Imagenes {
        return cast(JSON.parse(json), r("Imagenes"));
    }

    public static imagenesToJson(value: Imagenes): string {
        return JSON.stringify(uncast(value, r("Imagenes")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "ResultTopicSubmissions": o([
        ...
        { json: "film", js: "film", typ: u(undefined, r("Fashion")) },
        { json: "fashion", js: "fashion", typ: u(undefined, r("Fashion")) },
    ], false),
    "Fashion": o([
        { json: "status", js: "status", typ: r("Status") },
    ], false),
    "AltDescription": [
        "baby in diaper lying on bed",
